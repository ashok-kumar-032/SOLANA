...
const Developer = () => {
  return (
    <section className="bg_black py-5">
      <div className="container_my mt-xl-5 pt-xl-5">
        <Row>
          <Col lg={6} xs={12}>
            <div
              className="Developer_box p-5 h-100 box effect"
              data-aos="flip-up"
              data-aos-duration="2000"
            >
              <p className="fw_400 ff_Helvetica clr_white fs_36 text-center text-lg-start">
                Solana Developer Update
              </p>
              <p className="fw_400 ff_Helvetica clr_white fs_17 pt-2 text-center text-lg-start pb-5">
                Sign up to the newsletter and learn about new resources, new
                commits, new proposals, and more.
              </p>
              <div className="d-flex flex-column flex-sm-row align-items-center input_clr mt-5 ">
                <input
                  className="fw_600 ff_Helvetica clr_grey fs_15 input_box"
                  type="text"
                  placeholder="Email"
                />
                <span className="mt-3 mt-sm-0">
                  <button className="fw_600 all_btn effect ff_Helvetica clr_black bg_light_green text-nowrap fs_15 Sign_btn">
                    Sign up
                  </button>
                </span>
              </div>
          ...
          <Col lg={6} xs={12}>
            <div
              className="Developer_box p-5 h-100 mt-4 mt-lg-0 box"
              data-aos="flip-down"
              data-aos-duration="2000"
            >
              <p className="fw_400 ff_Helvetica clr_white fs_36 text-center text-lg-start">
              ...
              <p className="fw_400 ff_Helvetica clr_white fs_17 pt-2 text-center text-lg-start">
                More videos, more episodes. Discussions between industry leaders
                in both blockchain and technology, our team, and community
                developers.
              </p>
              <div className="mt-5 pt-4 d-flex flex-column flex-sm-row">
                <button className="fw_400 ff_Roboto clr_white fs_15 YouTube_btn effect w-100 all_btn">
                  YouTube
                  <span className="ms-3">
                    <svg
                      width="27"
                ...
                <button className="fw_400 all_btn ff_Roboto clr_white fs_15 YouTube_btn effect mt-3 mt-sm-0 w-100 ms-sm-4">
                  Podcast
                  <span className="ms-3">
                    <svg
                      width="25"
